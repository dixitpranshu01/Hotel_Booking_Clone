    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forgot_password_token', models.CharField(default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel', to='hotelbooking.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookhotel', to='hotelbooking.hotel')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookroom', to='hotelbooking.room')),
            ],
        ),
    ]
