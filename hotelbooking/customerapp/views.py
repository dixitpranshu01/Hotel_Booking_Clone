...
def sessioncheckcustomer_middleware(get_response):
    def middleware(request):
        ...
        if len(list1)>2:
            ...
            if strnewpath=='/customer/home/' or strnewpath=='/customer/availableroom/' or strnewpath=='/customer/bookroom/' or strnewpath=='/customer/bookingdetails/' or strnewpath=='/customer/editprofile/' or strnewpath == '/customer/changepassword/' or strnewpath == '/changepassword/' or strnewpath == '/forgotpassword/' :
